// В начале script.js добавьте проверку загрузки GSAP
document.addEventListener('DOMContentLoaded', function() {
    console.log('DOM loaded');
    console.log('GSAP loaded:', typeof gsap !== 'undefined');
    console.log('MorphSVGPlugin loaded:', typeof MorphSVGPlugin !== 'undefined');
    
    // Если GSAP не загрузился, покажите сообщение
    if (typeof gsap === 'undefined') {
        alert('GSAP не загрузился. Проверьте подключение к интернету.');
        return;
    }
    
    // Сначала сделайте SVG видимым
    gsap.set("svg", { 
        visibility: "visible",
        opacity: 1 
    });
