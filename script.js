(function () {
    // Удаляем платные плагины и переписываем анимацию
    function r(a) {
        gsap.killTweensOf(a, { opacity: true });
        gsap.fromTo(a, { opacity: 1 }, {
            duration: .07,
            opacity: Math.random(),
            repeat: -1
        });
    ...
    function t(a) {
        e && (a = l[d],
            ...
            gsap.timeline().to(a, {
                ...
                // Заменяем Physics2DPlugin на обычную анимацию
    ...
    // Убираем MorphSVGPlugin конвертацию
    ...
    // Упрощаем функцию получения пути
    c = function (a) {
        var path = document.querySelector(a);
    ...
    var treePathPoints = c(".treePath");
    var treeBottomPoints = c(".treeBottomPath");
    
    var timeline = gsap.timeline({ delay: 0, repeat: 0 });
    var k, m = gsap.utils.random(.5, 3, .001, true);

    // Создаем частицы
    (function () {
        for (var a = 201, b; -1 < --a;) {
            b = document.querySelector(p[a % p.length]).cloneNode(true);
            u.appendChild(b);
    ...
    (function () {
        ...
        // Используем MotionPathPlugin для основной анимации
        ...
        .to(".pContainer, .sparkle", {
            duration: 1,
            onStart: function () { e = false },
            x: treeBottomPoints[0].x,
            y: treeBottomPoints[0].y
        })
        .to(".pContainer, .sparkle", {
            duration: 2,
            onStart: function () { e = true },
            motionPath: {
                path: ".treeBottomPath",
        ...
        // Заменяем DrawSVGPlugin на обычную анимацию маски
        .fromTo(".treeBottomMask", {
